               ...
               <div className="container-fluid">
                  <div className="row align-items-center">
                     ...
                     <div className="col-auto text-end float-end ms-auto">
                        <a href="#" onClick={() => setshowmodel("showEvents")} className="btn btn-primary btn-sm"  >Create Event</a>
                     </div>
                  </div>
               </div>
            </div>
                     ...
                     <StickyBox offsetTop={20} offsetBottom={20}>
                        <div className="card">
                           ...
                           <div className="card-body">
                              ...
                              <a href="#0" onClick={() => setshowmodel("showCategory")} className="btn btn-primary w-100">
