...
import { Patient8, Patient2, Patient3, IMG01 } from "./image";
                  ...
                  <div className="col-md-4 d-flex">
                    <div className="card flex-fill">
                      ...
                      <div className="card-body">
                        ...
                        <p>
                          <a href="#0" className="text-secondary">
                            Secondary link
                          </a>
                        </p>
                        <p>
                          <a href="#0" className="text-success">
                            Success link
                          </a>
                        </p>
                        <p>
                        ...
                        <p>
                          <a href="#0" className="text-warning">
                            Warning link
                          </a>
                        </p>
                        <p>
                          <a href="#0" className="text-info">
                            Info link
                          </a>
                        </p>
                        <p>
                          <a href="#0" className="text-light bg-dark">
                            Light link
                          </a>
                        </p>
                        <p>
                        ...
                        <p>
                          <a href="#0" className="text-white bg-dark mb-0">
                            White link
                          </a>
                        </p>
                      </div>
