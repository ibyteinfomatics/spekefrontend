                            ...
                            <div className="filter-widget">
                                ...
                                <div>
                                    <label className="custom_check">
                                        ...
                                        <span className="checkmark"></span> Pediatric optometry
                                    </label>
                                </div>
                                <div>
                                    <label className="custom_check">
                                        <input type="checkbox" name="select_specialist" defaultChecked />
                                        <span className="checkmark"></span> Neuro optometry
                                    </label>
                                </div>
                                <div>
                                    <label className="custom_check">
                                        <input type="checkbox" name="select_specialist" />
                                        <span className="checkmark"></span> Optometry
                                    </label>
                                </div>
                                <div>
                                    <label className="custom_check">
                                ...
                                <div className="btn-search">
                                    <button type="button" className="btn btn-block w-100">Search</button>
                                </div>	
                            </div>
                        </div>
        );
