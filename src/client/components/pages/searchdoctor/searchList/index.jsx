                    ...
                    <div className="doctor-widget">
                        <div className="doc-info-left">
                            ...
                            <div className="doc-info-cont">
                                ...
                                <h5 className="doc-department"><img src={IMG_sp_02} className="img-fluid" alt="Speciality" />Optometry</h5>
                                ...
                                <div className="clinic-details">
                                    ...
                                    <ul className="clinic-gallery">
                                        <li>
                                            <a href="#0" onClick={() => setState({ isOpen: true, photoIndex: 0 })}>
                                                <img src={IMG_fe_01} alt="Feature" />
                                            </a>
                                        </li>
                                        <li>
                                            <a href="#0" onClick={() => setState({ isOpen: true, photoIndex: 1 })}>
                                                <img src={IMG_fe_02} alt="Feature" />
                                            </a>
                                        </li>
                                        <li>
                                            <a href="#0" onClick={() => setState({ isOpen: true, photoIndex: 2 })}>
                                                <img src={IMG_fe_03} alt="Feature" />
                                            </a>
                                        </li>
                                        <li>
                                            <a href="#0" onClick={() => setState({ isOpen: true, photoIndex: 3 })}>
                        ...
                        <div className="doc-info-right">
                            <div className="clini-infos">
                                <ul>
                                    ...
                                    </i> $300 - $1000 <OverlayTrigger overlay={<Tooltip id="tooltip-disabled">Lorem Ipsum</Tooltip>}>
                    ...
                    <div className="doctor-widget">
                        <div className="doc-info-left">
                            ...
                            <div className="doc-info-cont">
                                ...
                                <h5 className="doc-department"><img src={IMG_sp_03} className="img-fluid" alt="Speciality" />Optometry</h5>
                                <div className="rating">
                                    <i className="fas fa-star filled"></i>
                                    <i className="fas fa-star filled"></i>
                                    <i className="fas fa-star filled"></i>
                        ...
                        <div className="doc-info-right">
                            <div className="clini-infos">
                                <ul>
                                    ...
                                    <li><i className="far fa-money-bill-alt"></i> $50 - $300 <OverlayTrigger overlay={<Tooltip id="tooltip-disabled">Lorem Ipsum</Tooltip>}>
                                            <span className="d-inline-block">
                                                <i className="fas fa-info-circle"></i>
                                            </span>
                                        </OverlayTrigger></li>
                    ...
                    <div className="doctor-widget">
                        <div className="doc-info-left">
                            ...
                            <div className="doc-info-cont">
                                ...
                                <p className="doc-speciality">MBBS, MD - General Medicine, DNB - Low Vision Therapy</p>
                                <p className="doc-department"><img src={IMG_sp_04} className="img-fluid" alt="Speciality" />Low Vision Therapy</p>
                                <div className="rating">
                                    <i className="fas fa-star filled"></i>
                                    <i className="fas fa-star filled"></i>
                                    <i className="fas fa-star filled"></i>
                        ...
                        <div className="doc-info-right">
                            <div className="clini-infos">
                                <ul>
                                    ...
                                    <li><i className="far fa-comment"></i> 35 Feedback</li>
                                    <li><i className="fas fa-map-marker-alt"></i> Newyork, USA</li>
                                    <li><i className="far fa-money-bill-alt"></i> $100 - $400 <OverlayTrigger overlay={<Tooltip id="tooltip-disabled">Lorem Ipsum</Tooltip>}>
                                            <span className="d-inline-block">
                                                <i className="fas fa-info-circle"></i>
                                            </span>
                                        </OverlayTrigger></li>
                    ...
                    <div className="doctor-widget">
                        <div className="doc-info-left">
                            ...
                            <div className="doc-info-cont">
                                ...
                                <p className="doc-speciality">MBBS, MS - General Surgery, MCh - Pediatric optometry</p>
                                <p className="doc-department"><img src={IMG_sp_05} className="img-fluid" alt="Speciality" />Pediatric optometry</p>
                                <div className="rating">
                                    <i className="fas fa-star filled"></i>
                                    <i className="fas fa-star filled"></i>
                                    <i className="fas fa-star filled"></i>
                        ...
                        <div className="doc-info-right">
                            <div className="clini-infos">
                                <ul>
                                    ...
                                    <li><i className="fas fa-map-marker-alt"></i> Newyork, USA</li>
                                    <li><i className="far fa-money-bill-alt"></i> $150 - $250 <OverlayTrigger overlay={<Tooltip id="tooltip-disabled">Lorem Ipsum</Tooltip>}>
                                            <span className="d-inline-block">
                                                <i className="fas fa-info-circle"></i>
                                            </span>
                                        </OverlayTrigger></li>
                        ...
                        <div className="doc-info-right">
                            <div className="clini-infos">
                                <ul>
                                    ...
                                    <li><i className="far fa-money-bill-alt"></i> $100 - $500 <OverlayTrigger overlay={<Tooltip id="tooltip-disabled">Lorem Ipsum</Tooltip>}>
                                            <span className="d-inline-block">
                                                <i className="fas fa-info-circle"></i>
                                            </span>
                                        </OverlayTrigger>
