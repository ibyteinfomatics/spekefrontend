																		...
																		<tr>
																			<td>
																				<h2 className="table-avatar">
																					...
																					<Link to="/doctor/patient-profile">Michelle Wagner <span>#PT0002</span></Link>
																				</h2>
																			</td>
																			<td>1 Nov 2020<span className="d-block text-info">8.00 AM</span></td>
																			<td>General</td>
																			<td>Old Patient</td>
																			<td className="text-center">$75</td>
																			<td className="text-end">
																		...
																		<tr>
																			<td>
																				<h2 className="table-avatar">
																					<Link to="/doctor/patient-profile" className="avatar avatar-sm me-2">
																						<img className="avatar-img rounded-circle" src={IMG06} alt="User" /></Link>
																					<Link to="/doctor/patient-profile">James Lopez <span>#PT0003</span></Link>
																				</h2>
																			</td>
																			<td>28 Oct 2019 <span className="d-block text-info">8.00 AM</span></td>
																			<td>General</td>
																			<td>Old Patient</td>
																		...
																		<tr>
																			<td>
																				<h2 className="table-avatar">
																					<Link to="/doctor/patient-profile" className="avatar avatar-sm me-2">
																						<img className="avatar-img rounded-circle" src={IMG06} alt="User" /></Link>
																					<Link to="/doctor/patient-profile">Carol Joseph <span>#PT0005</span></Link>
																				</h2>
																			</td>
																			<td>27 Oct 2019 <span className="d-block text-info">8.00 AM</span></td>
																			<td>General</td>
