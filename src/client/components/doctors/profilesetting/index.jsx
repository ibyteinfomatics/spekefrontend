...
const getUserDetails=async()=>{
	const details =await registation.getUserDetails();
...
const handlePhoto = (e) => {
    ...
    Object.keys(files).map((item, i) => {
      if (files[item].name.match(/\.(jpg|jpeg|png|JPG|JPEG|PNG)$/)) {
        ...
        setStoryImage(files[item]);
      } else {
		  console.log("Please select jpg | jpeg | png | JPG| JPEG | PNG  type files");
      }
    });
};

  // upload image profile on server
  const uploadUserProfile =async()=>{
	  const responseOfImageUpload = await registation.uploadUserImage({profile_photo:storyImage});
  }
							...
							<div className="row">
								...
								<div className="col-md-7 col-lg-8 col-xl-9">
											...
											<div className="row form-row">
													...
													<div className="form-group">
														<div className="change-avatar">
															<div className="profile-img">
																<img src={image !=='' ? image :IMG01} alt="User" />
															</div>
															<div className="upload-img">
																<div className="change-photo-btn">
																	<span><i className="fa fa-upload"></i> Upload Photo</span>
																	<input type="file" className="upload" onClick={(e)=> handlePhoto(e)}/>
																</div>
												...
												<div className="col-md-6">
													<div className="form-group">
														...
														<input type="text" className="form-control" value={user?.full_name}/>
													</div>
												</div>
												<div className="col-md-6">
													<div className="form-group">
												...
												<div className="col-md-6">
													<div className="form-group">
														...
														<input type="text" className="form-control" value={user?.mobile_number}/>
													</div>
												</div>
												<div className="col-md-6">
													<div className="form-group">
									...
									<div className="submit-section submit-btn-bottom">
										<button type="button" className="btn btn-primary submit-btn"  onClick={()=> uploadUserProfile()}>Save Changes</button>
									</div>
