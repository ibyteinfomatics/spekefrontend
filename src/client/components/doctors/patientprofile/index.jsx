                                ...
                                <tr>
                                  <td>
                                    <h2 className="table-avatar">
                                      ...
                                      <Link to="/patient/doctor-profile">Dr. Fred Ortego  <span>Optometry</span></Link>
                                    </h2>
                                  </td>
                                ...
                                <tr>
                                  ...
                                  <td>
                                    <h2 className="table-avatar">
                                      ...
                                      <Link to="/patient/doctor-profile">Dr. Matthew Dodd <span>Optometry</span></Link>
                                    </h2>
                                  </td>
                                  <td className="text-end">
                                    <div className="table-action">
                                ...
                                <tr>
                                  ...
                                  <td>
                                    <h2 className="table-avatar">
                                      ...
                                      <Link to="/patient/doctor-profile">Dr. Lane Seay  <span>Cardiology</span></Link>
                                    </h2>
                                  </td>
                                  <td className="text-end">
                                    <div className="table-action">
                                ...
                                <tr>
                                  ...
                                  <td>
                                    <h2 className="table-avatar">
                                      ...
                                      <Link to="/patient/doctor-profile">Dr. Ruby Perrin <span>Optometry</span></Link>
                                    </h2>
                                  </td>
                                  <td className="text-end">
                                    <div className="table-action">
                                ...
                                <tr>
                                  ...
                                  <td>
                                    <h2 className="table-avatar">
                                      ...
                                      <Link to="/patient/doctor-profile">Dr. Fred Ortego <span>Orthopaedics</span></Link>
                                    </h2>
                                  </td>
                                  <td className="text-end">
                                    <div className="table-action">
                                ...
                                <tr>
                                  ...
                                  <td>
                                    <h2 className="table-avatar">
                                      ...
                                      <Link to="/patient/doctor-profile">Dr. Deborah Angel <span>Neurology</span></Link>
                                    </h2>
                                  </td>
                                  <td className="text-end">
                                    <div className="table-action">
                                ...
                                <tr>
                                  ...
                                  <td>
                                    <h2 className="table-avatar">
                                      ...
                                      <Link to="/patient/doctor-profile">Dr. Sofia Brient <span>Dermatology</span></Link>
                                    </h2>
                                  </td>
                                  <td className="text-end">
                                    <div className="table-action">
                                ...
                                <tr>
                                  ...
                                  <td>
                                    <h2 className="table-avatar">
                                      ...
                                      <Link to="/patient/doctor-profile">Dr. Marvin Campbell  <span>Optometry</span></Link>
                                    </h2>
                                  </td>
                                  <td className="text-end">
                                    <div className="table-action">
                                ...
                                <tr>
                                  ...
                                  <td>
                                    <h2 className="table-avatar">
                                      ...
                                      <Link to="/patient/doctor-profile">Dr. Katharine Berthold <span>Optometry</span></Link>
                                    </h2>
                                  </td>
                                  <td className="text-end">
                                    <div className="table-action">
                            ...
                            <table className="table table-hover table-center mb-0">
                              ...
                              <tbody>
                                <tr>
                                  ...
                                  <td>14 Nov 2019</td>
                                  <td>Optometry Filling</td>
                                  <td><Link to="#">Optometry-test.pdf</Link></td>
                                  <td>
                                    <h2 className="table-avatar">
                                      <Link to="/patient/doctor-profile" className="avatar avatar-sm me-2">
                                        <img className="avatar-img rounded-circle" src={IMG01} alt="User Image" />
                                ...
                                <tr>
                                  ...
                                  <td>
                                    <h2 className="table-avatar">
                                      ...
                                      <Link to="/patient/doctor-profile">Dr. John Gibbs <span>Optometry</span></Link>
                                    </h2>
                                  </td>
                                  <td className="text-end">
                                    <div className="table-action">
                                ...
                                <tr>
                                  ...
                                  <td>
                                    <h2 className="table-avatar">
                                      ...
                                      <Link to="/patient/doctor-profile">Dr. Olga Barlow <span>Optometry</span></Link>
                                    </h2>
                                  </td>
                                  <td className="text-end">
                                    <div className="table-action">
                                ...
                                <tr>
                                  ...
                                  <td>
                                    <h2 className="table-avatar">
                                      ...
                                      <Link to="/patient/doctor-profile">Ruby Perrin <span>Optometry</span></Link>
                                    </h2>
                                  </td>
                                  <td>$450</td>
                                  <td>14 Nov 2019</td>
