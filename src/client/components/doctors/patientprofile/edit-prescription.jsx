                  ...
                  <div className="pro-widget-content">
                    <div className="profile-info-widget">
                      ...
                      <div className="profile-det-info">
                        <h3><Link to="/doctor/patient-profile">Lesley Turner</Link></h3>
              ...
              <div className="card">
                ...
                <div className="card-body">
                  <div className="row">
                    <div className="col-sm-6">
                      <div className="biller-info">
                        <h4 className="d-block">Dr. Reginald Arnold</h4>
                        <span className="d-block text-sm text-muted">Coronary Artery Bypass</span>
                  ...
                  <div className="add-more-item text-end">
                    <Link to="#"><i className="fa fa-plus-circle"></i> Add More</Link>
                  </div>
                  {/* <!-- /Add Item -->
