									...
									<div className="chat-cont-left">
										...
										<div className="chat-users-list">
											<div className="chat-scroll">
												...
												<img src={IMG01} alt="User" className="avatar-img rounded-circle" />
													...
													<div className="media-body flex-grow-1">
														<div>
															<div className="user-name">Zada Walker</div>
											...
											<img src={IMG02} alt="User" className="avatar-img rounded-circle" />
													...
													<div className="media-body flex-grow-1">
														<div>
															<div className="user-name">Charles Flores</div>
												...
												<img src={IMG03} alt="User" className="avatar-img rounded-circle" />
													...
													<div className="media-body flex-grow-1">
														<div>
															<div className="user-name">Gore Volodin</div>
												...
												<a href="#" className="media read-chat d-flex">
													...
													<div className="media-body flex-grow-1">
														<div>
															<div className="user-name">Jean Knapp</div>
												...
												<a href="#" className="media read-chat d-flex">
												   ...
												   <img src={IMG04} alt="User" className="avatar-img rounded-circle" />
													...
													<div className="media-body flex-grow-1">
														<div>
															<div className="user-name">Essie Laws</div>
												...
												<a href="#" className="media read-chat d-flex">
													...
													<div className="media-body flex-grow-1">
														<div>
															<div className="user-name">Tena Evangelista</div>
												...
												<a href="#" className="media read-chat d-flex">
													...
													<div className="media-body flex-grow-1">
														<div>
															<div className="user-name">Hope Golubova</div>
												...
												<a href="#" className="media read-chat d-flex">
													...
													<div className="media-body flex-grow-1">
														<div>
															<div className="user-name">Sandra Pugh</div>
