								...
								<div className="col-md-6 col-lg-4 col-xl-3">
									<div className="profile-widget">
										...
										<div className="pro-content">
											...
											<p className="speciality">M.Sc. Optometry</p>
								...
								<div className="col-md-6 col-lg-4 col-xl-3">
									<div className="profile-widget">
										...
										<div className="pro-content">
											...
											<p className="speciality">B.Sc. Optometry, M.Sc. Optometry</p>
											<div className="rating">
												<i className="fas fa-star filled"></i>
												<i className="fas fa-star filled"></i>
												<i className="fas fa-star filled"></i>
								...
								<div className="col-md-6 col-lg-4 col-xl-3">
									<div className="profile-widget">
										...
										<div className="pro-content">
											...
											<p className="speciality">MBBS, MD - General Medicine, DM - Neuro optometry</p>
											<div className="rating">
												<i className="fas fa-star filled"></i>
												<i className="fas fa-star filled"></i>
												<i className="fas fa-star filled"></i>
								...
								<div className="col-md-6 col-lg-4 col-xl-3">
									<div className="profile-widget">
										...
										<div className="pro-content">
											...
											<p className="speciality">B.Sc, M.Sc. Optometry</p>
											<div className="rating">
												<i className="fas fa-star filled"></i>
												<i className="fas fa-star filled"></i>
												<i className="fas fa-star filled"></i>
								...
								<div className="col-md-6 col-lg-4 col-xl-3">
									<div className="profile-widget">
										...
										<div className="pro-content">
											...
											<p className="speciality">MBBS, MS - ENT, Diploma in M.Sc. Optometry</p>
											<div className="rating">
												<i className="fas fa-star filled"></i>
												<i className="fas fa-star filled"></i>
												<i className="fas fa-star filled"></i>
