                        ...
                        <div className="row align-items-center mb-4">
                            ...
                            <div className="col-md-6 col-auto">
                                <div className="view-icons">
                                    <Link to="/patient/doctor-grid" className="grid-view"><i className="fas fa-th-large"></i></Link>
                                    <Link to="/patient/doctor-list" className="list-view active"><i className="fas fa-bars"></i></Link>
                                </div>
                                ...
                                <div className="doctor-widget">
                                    <div className="doc-info-left">
                                        ...
                                        <div className="doc-info-cont">
                                            ...
                                            <h5 className="doc-department"><img src={IMG10} className="img-fluid" alt="Speciality" />Pediatric optometry</h5>
                                ...
                                <div className="doctor-widget">
                                    <div className="doc-info-left">
                                        ...
                                        <div className="doc-info-cont">
                                            ...
                                            <h5 className="doc-department"><img src={IMG11} className="img-fluid" alt="Speciality" />Geriatric optometry</h5>
                                            <div className="rating">
                                                <i className="fas fa-star filled"></i>
                                                <i className="fas fa-star filled"></i>
                                                <i className="fas fa-star filled"></i>
                                ...
                                <div className="doctor-widget">
                                    <div className="doc-info-left">
                                        ...
                                        <div className="doc-info-cont">
                                            ...
                                            <p className="doc-department"><img src={IMG10} className="img-fluid" alt="Speciality" />Low vision therapy</p>
                                            <div className="rating">
                                                <i className="fas fa-star filled"></i>
                                                <i className="fas fa-star filled"></i>
                                                <i className="fas fa-star filled"></i>
                                ...
                                <div className="doctor-widget">
                                    <div className="doc-info-left">
                                        ...
                                        <div className="doc-info-cont">
                                            ...
                                            <p className="doc-department"><img src={IMG12} className="img-fluid" alt="Speciality" />Pediatric optometry</p>
                                            <div className="rating">
                                                <i className="fas fa-star filled"></i>
                                                <i className="fas fa-star filled"></i>
                                                <i className="fas fa-star filled"></i>
                                ...
                                <div className="doctor-widget">
                                    <div className="doc-info-left">
                                        ...
                                        <div className="doc-info-cont">
                                            ...
                                            <p className="doc-department"><img src={IMG13} className="img-fluid" alt="Speciality" />Pediatric optometry</p>
                                            <div className="rating">
                                                <i className="fas fa-star filled"></i>
                                                <i className="fas fa-star filled"></i>
                                                <i className="fas fa-star filled"></i>
