...
const DoctorProfile = () => {
	...
	const handleSelect = (key) => setState({ ...state, key });
	const openModal = (id) => setState({ ...state, activeModal: id });
	const handleCloseModal = () => setState({ ...state, activeModal: false });
							...
							<div className="doctor-widget">
								<div className="doc-info-left">
									...
									<div className="doc-info-cont">
										...
										<p className="doc-department"><img src={IMG02} className="img-fluid" alt="Speciality" />Optometry</p>
										...
										<div className="clinic-details">
											...
											<ul className="clinic-gallery">
												<li>
													<a href="#" onClick={() => setState({ isOpen: true, photoIndex: 0 })}>
														<img src={IMG03} alt="Feature" />
													</a>
												</li>
												<li>
													<a href="#" onClick={() => setState({ isOpen: true, photoIndex: 1 })}>
														<img src={IMG04} alt="Feature" />
													</a>
												</li>
												<li>
													<a href="#" onClick={() => setState({ isOpen: true, photoIndex: 2 })}>
														<img src={IMG05} alt="Feature" />
													</a>
												</li>
												<li>
													<a href="#" onClick={() => setState({ isOpen: true, photoIndex: 3 })}>
										...
										<div className="clinic-services">
											<span>Low vision therapys</span>
											<span>Teeth Laser</span>
										</div>
									</div>
								</div>
														...
														<li>
															...
															<div className="experience-content">
																<div className="timeline-content">
																	<a href="#/" className="name">American Optometry Medical University</a>
																	<div>BDS</div>
												...
												<div className="experience-box">
													<ul className="experience-list">
														<li>
															...
															<div className="experience-content">
																<div className="timeline-content">
																	<a href="#/" className="name">Glowing Smiles Family Optometry Clinic</a>
														...
														<li>
															...
															<div className="experience-content">
																<div className="timeline-content">
																	<a href="#/" className="name">Comfort Care Optometry Clinic</a>
														...
														<li>
															...
															<div className="experience-content">
																<div className="timeline-content">
																	<a href="#/" className="name">Dream Smile Optometry Practice</a>
														...
														<li>
															...
															<div className="experience-content">
																<div className="timeline-content">
																	...
																	<h4 className="exp-title">The Optometry Professional of The Year Award</h4>
																	<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Proin a ipsum tellus. Interdum et malesuada fames ac ante ipsum primis in faucibus.</p>
																</div>
															</div>
														</li>
									...
									<div>
											...
											<div className="row">
												...
												<div className="col-md-6">
													<div className="clinic-content">
														<h4 className="clinic-name"><a href="#">Smile Cute Pediatric optometry Center</a></h4>
														<p className="doc-speciality">M.Sc. Optometry</p>
														<div className="rating">
															<i className="fas fa-star filled"></i>
															<i className="fas fa-star filled"></i>
															<i className="fas fa-star filled"></i>
														...
														<div className="clinic-details mb-0">
															<h5 className="clinic-direction">
																...
																USA <a href="#">Get Directions</a></h5>
															<div>
										...
										<div className="location-list">
											<div className="row">
												...
												<div className="col-md-6">
													<div className="clinic-content">
														<h4 className="clinic-name"><a href="#">The Family Optometristry Clinic</a></h4>
														<p className="doc-speciality">M.Sc. Optometry</p>
														<div className="rating">
															<i className="fas fa-star filled"></i>
															<i className="fas fa-star filled"></i>
														...
														<div className="clinic-details mb-0">
															<p className="clinic-direction"> <i className="fas fa-map-marker-alt"></i>
																2883  University Street, Seattle, Texas Washington, 98155<a href="#">Get Directions</a></p>
															<div>
