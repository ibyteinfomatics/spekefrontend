...
import IMG02 from "../../assets/images/profiles/avatar-02.jpg"
        ...
        <div className="content container-fluid">
          ...
          <div className="comp-sec-wrapper">
              ...
              <div className="row">
                ...
                <div className="col-md-12">
                  <div className="card">
                    ...
                    <div className="card-body">
                      <div className="avatar me-1">
                        <img className="avatar-img rounded" alt="User Image" src={IMG02} />
                      </div>
                      <div className="avatar me-1">
                        <img className="avatar-img rounded-circle" alt="User Image" src={IMG02} />
                      </div>
                    ...
                    <div className="card-body">
                      <div className="avatar-group">
                        <div className="avatar">
                          <img className="avatar-img rounded-circle border border-white" alt="User Image" src={IMG02} />
                        </div>
                        <div className="avatar">
                          <img className="avatar-img rounded-circle border border-white" alt="User Image" src={IMG03} />
                        </div>
                        <div className="avatar">
                          <img className="avatar-img rounded-circle border border-white" alt="User Image" src={IMG04} />
                        </div>
                        <div className="avatar">
            ...
            <section className="comp-section comp-buttons">
              ...
              <div className="card mb-4">
                ...
                <div className="card-body">
                  <button type="button" className="btn btn-primary"><span className="spinner-border spinner-border-sm me-2" role="status" />Primary</button>
                  <button type="button" className="btn btn-secondary"><span className="spinner-border spinner-border-sm me-2" role="status" />Secondary</button>
                  <button type="button" className="btn btn-success"><span className="spinner-border spinner-border-sm me-2" role="status" />Success</button>
                  <button type="button" className="btn btn-danger"><span className="spinner-border spinner-border-sm me-2" role="status" />Danger</button>
                  <button type="button" className="btn btn-warning"><span className="spinner-border spinner-border-sm me-2" role="status" />Warning</button>
                  <button type="button" className="btn btn-info"><span className="spinner-border spinner-border-sm me-2" role="status" />Info</button>
                  <button type="button" className="btn btn-dark"><span className="spinner-border spinner-border-sm me-2" role="status" />Dark</button>
                </div>
              </div>
              {/* /Progress Button */}
            </section>
            ...
            <section className="comp-section">
              ...
              <div className="card">
                ...
                <div className="card-body">
                  ...
                  <div className="modal-1 static-modal" tabIndex={-1} role="dialog">
              ...
              <div className="card">
                ...
                <div className="card-body">
                  {/* Simple demo*/}
                  <button className="btn btn-primary" type="button" data-bs-toggle="modal" data-original-title="test" data-target="#exampleModal">Simple</button>
                  ...
                  <button className="btn btn-primary" type="button" data-bs-toggle="modal" data-target="#exampleModalLong">Scrolling long content</button>
                  ...
                  <button className="btn btn-primary" type="button" data-bs-toggle="modal" data-target="#exampleModalCenter">Vertically centered</button>
                  ...
                  <button className="btn btn-primary" type="button" data-bs-toggle="modal" data-target="#tooltipmodal" >Tooltips and popovers</button>
                  <div className="modal fade" id="tooltipmodal" tabIndex={-1} role="dialog" aria-labelledby="tooltipmodal" aria-hidden="true">
                    <div className="modal-dialog modal-dialog-centered" role="document">
                      <div className="modal-content">
                        <div className="modal-header">
                          <h5 className="modal-title">Modal title</h5>
                        ...
                        <div className="modal-body">
                          ...
                          <p>This <a className="btn btn-primary popover-test" href="#" role="button" data-content="Popover body content is set in this attribute." data-container="#exampleModalPopovers" data-original-title="Popover title">button</a> triggers a popover on click.</p>
                          <hr />
                          <h5>Tooltips in a modal</h5>
                          <p><a className="tooltip-test" href="#" data-container="#exampleModalPopovers" data-original-title="Tooltip">This link</a> and <a className="tooltip-test" href="#" data-container="#exampleModalPopovers" data-original-title="Tooltip">that link</a> have tooltips on hover.</p>
                        </div>
                        <div className="modal-footer">
                          <button className="btn btn-secondary" type="button" data-bs-dismiss="modal">Close</button>
                          <button className="btn btn-primary" type="button">Save changes</button>
                  ...
                  <button className="btn btn-primary" type="button" data-bs-toggle="modal" data-target="#grid-modal">Using the grid</button>
                  <div className="modal fade" id="grid-modal" tabIndex={-1} role="dialog" aria-labelledby="grid-modal" aria-hidden="true">
                    <div className="modal-dialog modal-dialog-centered" role="document">
                      <div className="modal-content">
                        <div className="modal-header">
                          <h5 className="modal-title">Modal title</h5>
                        ...
                        <div className="modal-body grid-showcase">
                          <div className="container-fluid bd-example-row">
                            <div className="row">
                              ...
                              <div className="col-md-4 ms-auto"><span>.col-md-4 .ms-auto</span></div>
                            </div>
                            <div className="row">
                              <div className="col-md-3 ms-auto"><span>.col-md-3 .ms-auto</span></div>
                              <div className="col-md-2 ms-auto"><span>.col-md-2 .ms-auto</span></div>
                            </div>
                            <div className="row">
                              <div className="col-md-6 ms-auto"><span>.col-md-6 .ms-auto</span></div>
                            </div>
                            <div className="row">
          ...
          <div className="card">
            ...
            <div className="card-body btn-showcase">
              <button className="btn btn-primary" type="button" data-bs-toggle="modal" data-target="#exampleModalfat" data-whatever="@mdo">Open modal for @mdo</button>
              <button className="btn btn-primary" type="button" data-bs-toggle="modal" data-target="#exampleModalmdo" data-whatever="@fat">Open modal for @fat</button>
              <button className="btn btn-primary" type="button" data-bs-toggle="modal" data-target="#exampleModalgetbootstrap" data-whatever="@getbootstrap">Open modal for @getbootstrap</button>
              <div className="modal fade" id="exampleModalfat" tabIndex={-1} role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div className="modal-dialog" role="document">
                  <div className="modal-content">
                    <div className="modal-header">
              ...
              <div className="modal fade" id="exampleModalmdo" tabIndex={-1} role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div className="modal-dialog" role="document">
                  <div className="modal-content">
                    <div className="modal-header">
                    ...
                    <div className="modal-body">
                      <form>
                        <div className="form-group">
                          <label className="col-form-label" htmlFor="recipient-name">Recipient:</label>
                          <input className="form-control" id="recipient-name" type="text" defaultValue="@Mat" />
                        </div>
                        <div className="form-group">
                          <label className="col-form-label" htmlFor="message-text">Message:</label>
              ...
              <div className="modal fade" id="exampleModalgetbootstrap" tabIndex={-1} role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div className="modal-dialog" role="document">
                  <div className="modal-content">
                    <div className="modal-header">
                      <h5 className="modal-title">New message</h5>
          ...
          <div className="card">
            ...
            <div className="card-body">
              {/* Extra Large modal */}
              <button type="button" className="btn btn-primary" data-bs-toggle="modal" data-target=".bd-example-modal-xl">Extra large modal</button>
              ...
              {/* Large modal*/}
              <button className="btn btn-primary" type="button" data-bs-toggle="modal" data-target=".bd-example-modal-lg" >Large modal</button>
              ...
              {/* Small modal*/}
              <button className="btn btn-primary" type="button" data-bs-toggle="modal" data-target=".bd-example-modal-sm">Small modal</button>
